...
public class TestListnerAdapterErrorCollector implements IInvokedMethodListener {
...
public void afterInvocation(IInvokedMethod method, ITestResult result) {
		...
		if (method.isTestMethod()) {
			...
			List<Throwable> verificationFailures = ErrorCollectorTestNG.getVerificationFailures();
